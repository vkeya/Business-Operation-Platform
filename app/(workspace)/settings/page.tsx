...
export default function SettingsPage() {
  const settingsCards = [
    ...
    },
    {
      ...
      description:
        "Import, review, and manage business data as you onboard or migrate your workspace.",
        ...
        <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-300">
              ...
              users, access, and data management settings.
            </p>
          </div>
        ...
        <div className="flex flex-col gap-5 px-5 py-5 sm:flex-row sm:items-center sm:px-6 sm:py-6">
          ...
          <div>
            ...
            <p className="mt-1 text-xs leading-5 text-slate-500">
              Configure financial preferences, manage your data,
              and ensure your team has the appropriate level of
