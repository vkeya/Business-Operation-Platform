        ...
        <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 max-w-xl text-sm leading-6 text-slate-300 sm:text-base">
              Manage the products and services your business
              sells, including pricing and inventory tracking.
            </p>
          </div>
        ...
        <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Search, review and edit the items your business
              sells.
            </p>
          </div>
          ...
          {products.length === 0 ? (
            <div className="px-6 py-16 text-center sm:px-10">
              ...
              <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-500">
                Add your first product or service to start
                managing pricing, sales and inventory from
                Teketeke.
              </p>
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-xs leading-5 text-slate-500">
              Product pricing and inventory settings flow into
              your wider business operations.
            </p>
          </div>
